 ...
 */
/** 2012-04-05, wwpdb, RPS: modifying as per Allan Jardine's suggestion per http://datatables.net/forums/discussion/573/how-to-stay-on-current-page-after-re-draw/p1 **/
...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFilterComplete ( oSettings, oInput, iForce )
		{
			...
			/* Redraw the table */
			/** 2012-04-05, RPS: modifying as per Allan Jardine's suggestion per http://datatables.net/forums/discussion/573/how-to-stay-on-current-page-after-re-draw/p1 **/
			if ( EditorMod.bResetDisplay )
			{
